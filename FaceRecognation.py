      ...
      if nn is not None:
          ...
          for i in nn:                                   # none type error
            ...
            for row,prediction in zip(names,nn):
                  ...
                  msg =" Dear "+str(row[0])+" Criminal identified at:  Lat: "+str(18.560589)+"longitude : "+str(73.929360)+"  With Details "+str(nn)
                  print(msg)
                  #send_sms(str(row[1]),msg)
                  send_sms("7350706868",msg)
